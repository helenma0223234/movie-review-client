...
function App() {
  ...
  useEffect(() => {
    Axios.get('https://movie-review-mysql-deploy.herokuapp.com/api/get')
    .then((response) => {
  ...
  const submitReview = () => {
    ...
    Axios.post('https://movie-review-mysql-deploy.herokuapp.com/api/insert', {
      movieName: movieName, 
      movieReview: review,
      stars: currentValue
    }).then (() => {
  ...
  const deleteReview = (movieName) => {
    Axios.delete(`https://movie-review-mysql-deploy.herokuapp.com/api/delete/${movieName}`);
    setReviewList(produce(reviewList, draft => {
  ...
  const updateReview = (movieName) => {
    ...
    Axios.put("https://movie-review-mysql-deploy.herokuapp.com/api/update", {
      movieName: movieName, 
